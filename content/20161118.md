...
<h2>將所得到的點座標的.csv以Excel的畫圖，得到：</h2>
 
 <p><img src="./../40423203/40423203-2.png" width="800" /></p>

<h2>首先利用 Brython, 讀取40423203目錄中的 40423203.csv 座標檔案, 然後以 splitlines() 及 split() 取出各點的 x 座標與 y 座標後, 將點連成路徑曲線如下:</h2>  
<!-- 導入 Brython 標準程式庫 -->
